...
CLAUDE.md               AI 공통 규칙의 단일 원천 — 수정 금지 목록·작업 규약·정정 이력 (v205)
FILES.md                이 파일
...
| `docs/history/전략_v29.md` | ISA 서민형 세후의 당시 기록. **v203: 원화·5년 납입 후 20년 결과, 일반계좌 대비 +54.7%, 이득의 83%는 과세이연** (`research/axis_isa.py`) |
...
후속 전수리뷰 및 교정 장부: `research/CODE_REVIEW_2026-09-05.md` — v204 원대상 137개 파일·61건 처리표, v205 설명 정정, v207 추가 회계 결함 R01. 각 차수의 검토·실행 범위와 남은 한계를 분리한다.
