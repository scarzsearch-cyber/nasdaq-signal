...
research/   (57) 기각 판정의 재현 코드 + build_crisis_paths.py(v127 화면 데이터 생성 —
            예외적으로 산출물 data/crisis_paths.json 이 배포됨) + hypo_gates.py(2026-08-30
            소유자 지시 가설 실험 — 다자산 추세 이상형 2종, 관문② 탈락). 각 파일 상단에 경로보정 3줄
