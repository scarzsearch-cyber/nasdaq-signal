...
| `research/recovery_speed.py` | **[가설 검증] 「최근일수록 폭락 회복이 빨라졌다」** (2026-09-03, 04 §5-30) — 사건 정의 3종(사상최고가·지그재그·독립사건) · 반증 8종(창 절단·깊이 통제·코로나 제외·순열·실질·S&P·B 영향) · 예측 결과 전 등록 | **판단 불가** · 깊이가 진짜 변수(상관 −0.70) · 가설이 참이어도 B 엔 불리 |
