...
> **2026-09-05 Codex 교차검증 후속:** 아래 B15-1은 위상 수정 후에도 비율인출 잔액감소가
> 누락되어 추가 교정했다. B08 MIX50은 표류비용/N5실제회전 교정 후 통과 유지(채택 아님).
> `hypo_hex`는 이미v213 교정 경로라 §9-5의 일괄 「비용 미교정」 표기는 정확하지 않다.
> OOS 재등록/c21배수는 독립 재현됐으며, c21 MDD는 세전 경로임을 명시했다.
> 범위·수치·검사는 `audit/HANDOFF_CROSSCHECK_2026-09-05.md`를 따른다.
