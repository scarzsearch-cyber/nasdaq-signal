...
[★ 등록 관문 K1~K7 — 실행 전 고정. 전부 충족해야 부후보 등록]
  ...
  K1 비용 완화   최종 ≥ 1.15 × T4      (T4 0.2% = 109,451 → 한도 ≥ 125,869 · v210 자료 재실행 2026-09-05: 172,259 → ≥ 198,098)
  K2 방어 총량   MDD ≥ T4 MDD − 1.5%p  (T4 0.2% = −54.7% → 한도 ≥ −56.2% · v210 재실행: −52.3% → ≥ −53.8%)
  ※ 위 괄호 숫자는 설명용이고 코드는 refs 를 실행 시점 자료에서 다시 잰다 — v210 뒤에도 판정은 「전멸」 그대로(순회 B09).
