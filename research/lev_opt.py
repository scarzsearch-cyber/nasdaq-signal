...
KS = [1.0, 1.25, 1.5, 1.75, 2.0, 2.1, 2.2, 2.3, 2.4,
      2.5, 2.6, 2.7, 2.8, 2.9, 3.0]          # 2~3 은 0.1 步 (소유자 후속 질문)
...
def main():
    ...
    for k in KS:
        ...
        print(f'{k:>5.2f} {m["final"]:>12.1f} {m["cagr"]:>6.2f} {m["mdd"]:>7.1f} '
              f'{m["calmar"]:>7.3f} {p05(a):>8.1f} {m["rec"]/252:>7.1f} {w1:>7.1%} {w5:>7.1%}')
