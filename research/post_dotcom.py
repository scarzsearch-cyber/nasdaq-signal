...
def main():
    ...
    print('\n[4] 판정')
    print('  · **소유자 주장은 맞다** — 닷컴을 빼면 B 의 *수익* 우위는 34.9배 → 1.09배로')
    print('    거의 사라진다. 2010~ 만 보면 0.87배로 오히려 진다.')
    print('  · **그러나 값어치는 수익이 아니라 낙폭에 있다** — 2003~ 에서도 B 는')
    print('    MDD −49.7% vs 2배 맨몸 −83.2%. Calmar 0.499 vs 0.293 (**+70%**).')
    print('  · **결정적 대조는 [3]** — 닷컴을 한 번 겪으면 3배 맨몸 0.39배 · 무한매수')
    print('    0.30배 · VR 0.57배로 **계좌가 사라진다.** B 만 176배로 살아남는다.')
